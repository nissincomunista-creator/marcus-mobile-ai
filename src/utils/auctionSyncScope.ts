...
export const SYNC_SOURCE_IDS = 'leilaoimovel joaoemilio biasi silas portella rioleiloes alexandro paulobotelho jv depaula rymer megaleiloes ayupp portalzuk saraiva sold schulmann comprei pestana onildo gustavo mgl leiloei bb emgea santander vitrinebradesco ricart pamela facanha frazao leilaovip freitas'.split(' ');
