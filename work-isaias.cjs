...
(async () => {
  ...
  try {
    const draft = await enrichLotDetails(browser, { portalId: "isaias", auctioneerName: "Isa\xEDas Leil\xF5es", title: "Im\xF3vel em Juiz de Fora", address: "", neighborhood: "Benfica", city: "Juiz de Fora", state: "MG", propertyType: "Casa", sizeSqm: 0, auctionPrice: 0, auctionDate: "", auctionLink: "https://www.isaiasleiloes.com.br/item/27791/detalhes", origin: "judicial" });
    import_node_fs.default.writeFileSync("isaias-validation.json", JSON.stringify([draft], null, 2));
